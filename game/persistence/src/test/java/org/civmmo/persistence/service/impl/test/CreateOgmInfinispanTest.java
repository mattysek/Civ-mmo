...
public class CreateOgmInfinispanTest {
    ...
    public void testCreateOne() {
        ...
        runAndLogDuration(actionService::create, a);
        runAndLogDuration(buildingService::create, b);
    ...
    public void testCreateMany() {
        ...
        supplyListOfCount(count, this::supplyActionDto)
                .forEach(a -> runAndLogDuration(actionService::create, a));
        supplyListOfCount(count, this::supplyBuildingDto)
                .forEach(a -> runAndLogDuration(buildingService::create, a));
    }
