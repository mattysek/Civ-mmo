...
public class UpdateOgmInfinispanTest {
    ...
    public void testCreateOne() {
        ...
        ActionDto c = supplyActionDto();
        a.setAplicableTo(c.getAplicableTo());
        a.setCombatModifiers(c.getCombatModifiers());
        a.setName(c.getName());
        
        b.setName(UUID.randomUUID().toString());
        
        runAndLogDuration(actionService::update, a);
        runAndLogDuration(buildingService::update, b);
    ...
    public void testCreateOneWithManySubentities() {
        ...
        ActionDto c = supplyActionDto(100);
        a.setAplicableTo(c.getAplicableTo());
        a.setCombatModifiers(c.getCombatModifiers());
        a.setName(c.getName());
    ...
    public void testCreateMany() {
        ...
        actions.forEach(a -> runAndLogDuration(actionService::update, a));
        buildings.forEach(a -> runAndLogDuration(buildingService::update, a));
    }
